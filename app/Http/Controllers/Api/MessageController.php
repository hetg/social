...
class MessageController extends Controller
{
    ...
    /**
     * @OA\Post(
     *     path="/api/chat/{chatId}/message/{messageId}/read/{userId}",
     *     summary="Send user read message to chat by ID",
     *     description="Send user read message to chat by ID",
    ...
    public function readMessage(int $chatId, int $messageId, int $userId){
        return $this->messageService->readMessage($chatId, $messageId, $userId);
    }
